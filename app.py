...
def filmes(propriedade):
	if propriedade=='populares':
		...
		url="https://api.themoviedb.org/3/search/movie?query=kids&include_adult=false&language=en-US&api_key=44271fcf35be9f198059a3ece4aa58ce"
	elif propriedade=='2010':
		url="https://api.themoviedb.org/3/discover/movie?primary_release_year=2010&api_key=44271fcf35be9f198059a3ece4aa58ce"
	elif propriedade=='drama':
		url="https://api.themoviedb.org/3/search/movie?query=drama&include_adult=false&language=en-US&api_key=44271fcf35be9f198059a3ece4aa58ce"
	elif propriedade=='tom_cruise':
		url="https://api.themoviedb.org/3/discover/movie?with_genres=878&with_cast=500&sort_by=vote_average.desc&api_key=44271fcf35be9f198059a3ece4aa58ce"	

	resposta=urllib.request.urlopen(url)
	dados=resposta.read()
	jsondata=json.loads(dados)
	return render_template("filmes.html", filme=jsondata['results'])
